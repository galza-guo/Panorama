...
export function DatePickerInput({
  ...
  return (
    ...
    >
      <Group
        className={cn(
          "dark:bg-input/30 border-input ring-offset-background bg-input-bg h-input-height flex w-full flex-nowrap items-center rounded-md border px-3 py-1 text-sm whitespace-nowrap",
