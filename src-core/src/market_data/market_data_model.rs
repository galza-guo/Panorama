use crate::market_data::market_data_constants::{
    ...
    DATA_SOURCE_MARKET_DATA_APP, DATA_SOURCE_METAL_PRICE_API, DATA_SOURCE_OPEN_EXCHANGE_RATES,
    DATA_SOURCE_TIANTIAN_FUND, DATA_SOURCE_YAHOO,
};
