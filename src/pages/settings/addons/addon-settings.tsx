    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <SettingsHeader
          ...
          text="Install and manage add-ons to extend Panorama's functionality."
        />
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Add-ons let you extend Panorama with new features, custom analytics, and
            ...
            {isLoadingAddons ? (
              ...
              <EmptyPlaceholder>
                ...
                <EmptyPlaceholder.Description>
                  Get started by installing your first add-on to extend Panorama&apos;s
                  functionality.
                </EmptyPlaceholder.Description>
