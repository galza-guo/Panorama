...
Panorama. Understanding these types is essential for creating activities
...
| **DEPOSIT**        | Incoming funds from outside Panorama.                                                                | Increases cash             | –                               |
...
| **TRANSFER_IN**    | Move cash or assets into this account from another Panorama account (asset cost basis preserved).    | Increases cash or quantity | Increases quantity for assets   |
...
Activities can be inserted retroactively; Panorama recalculates balances
automatically.
