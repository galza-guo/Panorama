...
| 2026-04-16 | AI Rust exact-alignment follow-up | Restored the remaining non-provider AI Rust runtime/tooling files to the upstream `v3.2.1` versions, except for the narrow compatibility shim documented as P-007 where Panorama’s current core traits still differ from upstream signatures |
