...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Bucket commands
            commands::buckets::get_buckets,
            commands::buckets::create_bucket,
            commands::buckets::update_bucket,
            commands::buckets::delete_bucket,
            commands::buckets::get_bucket_account_defaults,
            commands::buckets::assign_bucket_account_default,
            commands::buckets::remove_bucket_account_default,
            commands::buckets::get_bucket_holding_overrides,
            commands::buckets::assign_bucket_holding_override,
            commands::buckets::remove_bucket_holding_override,
            commands::buckets::get_bucket_asset_assignments,
            commands::buckets::assign_bucket_asset,
            commands::buckets::remove_bucket_asset_assignment,
            commands::buckets::get_bucket_allocation,
            // Activity commands
