...
vi.mock("@panorama/ui/components/ui/animated-toggle-group", () => ({
  AnimatedToggleGroup: ({
    items,
    value,
    onValueChange,
...
// Mock Checkbox
vi.mock("@panorama/ui/components/ui/checkbox", () => ({
  Checkbox: ({
    id,
    checked,
    onCheckedChange,
...
// Mock RadioGroup
vi.mock("@panorama/ui/components/ui/radio-group", () => ({
  RadioGroup: ({
    value,
    children,
    className,
...
// Mock Label
vi.mock("@panorama/ui/components/ui/label", () => ({
  Label: ({
    htmlFor,
    children,
    className,
